  ...
  return (
    <div className='b bg-slate-900 text-white  flex items-center justify-between px-2'>
      ...
      <div className='flex items-center flex-grow'>
        <div className='bg-gray-600 flex items-center p-2 rounded-l-lg '>
          <span className='sm:text-xs sm:font-thin'>All</span>
          <i><ion-icon name="arrow-dropdown"></ion-icon></i>
        </div>
        <input className='p-2 flex-grow' type="text" placeholder='search '/>
        <i className='text-black cursor-pointer text-2xl bg-orange-300 rounded-r-lg p-1'><ion-icon name="search"></ion-icon></i>
      </div>
      <div >
